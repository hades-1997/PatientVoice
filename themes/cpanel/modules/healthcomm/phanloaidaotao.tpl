		...
		<div class="col-md-12 col-lg-6">
			<div class="card">
				<div class="card-header">
					<h5>PHÂN LOẠI ĐÀO TẠO</h5><span></span>
				</div>
			<div class="card-block">			
				...
				<div class="form-group row">
					<div class="col-sm-12">
							<div class="input-group">
									<span class="input-group-addon" id="type_select" style="width: auto;">Phân loại:</span>
				...
				<div class="form-group row">
					 <div class="col-sm-12">
						<div class="col-form-label">Đơn vị(*):</div>
						<input name='unit' value='{DATA.unit}' type='text' class='form-control' placeholder="Ví dụ: Số tiết; số báo cáo">
					 </div>
				</div>
				<div class="form-group row">
					 <div class="col-sm-12">
						<div class="col-form-label">Hệ số quy đổi đơn vị ra số tiết(*):</div>
						<input name='value' value='{DATA.value}' type='text' class='form-control' placeholder="Ví dụ: 1; 1.5; 2...">
					 </div>
				</div>
			...
			<table id="tbl_danhsach" class="table table-hover" >
						...
						<!-- BEGIN: item -->
							<tr>
								...
								<td class="text-center phanhang">{ITEM.unit}</td>
								<td class="text-center phanhang">{ITEM.value}</td>
