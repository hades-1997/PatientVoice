...
<div class="col-md-12">
	<div class="card">
		<div class="card-header">
			<h4 class="" style="text-transform: uppercase;color: #4099ff;">Số lượng nhân viên y tế theo các mức giờ tín chỉ trong 5 năm</h4>
		...
		<div class="col-md-12 col-lg-6">
			 <div class="card">
				 ...
				 <div class="card-block">
					<div id="pieTke" style="max-height: 400px; display: block;"></div>
				 </div>
			 </div>
		 </div>
		 <div class="col-md-12 col-lg-6">
			 <div class="card">
				 ...
				 <div class="card-block">
					<div id="bar_tke" style="max-height: 400px; display: block;"></div>
				 </div>
			 </div>
		 </div>
	</div>
