	...
	<table class="table table-striped table-bordered table-hover" id="tbl_danhsach"> 
		<thead>
			<tr>
				...
				<th class="text-center">Cơ sở đào tạo</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">{ROW.id_kh}</td>
				...
				<td class="text-center">{ROW.tenchungchi}</td>
				<td class="text-center">{ROW.csdaotao}</td>
				<td class="text-center">{ROW.ghichu}</td>
				<td class="text-center">{ROW.nguoiky}</td>
